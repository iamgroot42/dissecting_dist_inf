...
if __name__ == "__main__":
    ...
    if args.filter == "Young":
        ...
        # ]
        fc_perf = [
            [81.05, 80.65, 50.0, 81.6, 80.45],
            [70.6, 70.8, 67.1, 68.25, 72.4],
            [61.9, 63.0, 62.7, 50.0, 64.3],
            [54.4, 50.0, 50.0, 56.2, 55.2],
            [50.05, 50.7, 51.45, 52.15, 53.45],
            [50.0, 51.15, 50.0, 50.75, 50.3],
            [50.15, 52.1, 55.4, 54.75, 49.5], #Rerun
            [61.65, 49.95, 54.55, 50.75, 61.15], #Rerun
            [66.1, 66.3, 64.45, 62.55, 67.0], #Rerun
            [67.15, 75.6, 76.05, 50.0, 50.0]
        ]

        conv_perf = [
            [58.7, 54.05, 62.95, 57.05, 50.15],
            [54.0, 51.45, 55.85, 57.35, 51.4],
            [49.9, 51.9, 49.5, 50.25, 50.95],
            [51.05, 50.6, 49.95, 51.05, 48.25],
            [50.0, 48.9, 49.7, 50.4, 50.0],
            [50.65, 50.25, 49.5, 50.2, 51.95],
            [51.3, 50.0, 50.0, 50.0, 54.85],
            [51.85, 57.35, 53.0, 56.75, 50.0],
            [64.1, 54.9, 65.45, 67.35, 57.8], #Rerun
            [62.35, 79.3, 77.2, 62.85, 84.9]
        ]
        # OLD
        # conv_perf = [
        ...
        combined_perf = [
            ...
            [52.15, 50.0, 50.0, 50.1, 51.3], #Running
        ...
        baselines = [(50.15, 50.25), (50.1, 50.15), (50.36, 51.01), (48.65, 49.9), (49.23, ), (49.34, 48.9, 48.92), (44.57), (50.5), (50.14), (49.9, 49.9)]
        # OLD
