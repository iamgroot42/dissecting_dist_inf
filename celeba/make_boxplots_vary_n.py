...
if __name__ == "__main__":
    ...
    if args.filter == "Young":
        ...
        raw_data = {
            ...
            "Robust": {
                1600: [
                        [99.73863042341871, 99.94772608468374, 99.94772608468374, 100.0, 100.0],
                        [99.89545216936749, 100.0, 99.94772608468374, 100.0, 97.69994772608469],
                        [71.71981181390485, 98.170412963931, 99.32043910088866,99.89545216936749, 99.73863042341871],
                        [99.58180867746994, 99.21589127025614, 99.37271301620491, 99.2681651855724, 99.58180867746994],
                        [80.7109252483011, 88.08154730789336, 69.89022477783585, 72.3993727130162, 69.57658128593832],
                        [85.97097442985488, 76.64132688320663, 86.38562543192813, 72.21838286109191, 74.77539737387698],
                        [83.69053842132776, 77.5222164140094, 97.59539989545218, 95.71353894406691, 95.55671719811814],
                        [89.02247778358598, 99.47726084683742, 99.94772608468374,97.75222164140094, 99.58180867746994],
                        [55.31, 69.89, 57.19, 90.28, 87.78],
                        [47.72608468374281, 47.72608468374281, 47.72608468374281, 47.72608468374281, 47.72608468374281]
                    ]
            }
            # "first 2": {
            #     # 10: [
    ...
    sns_plot.figure.savefig("./meta_boxplot_varying_n_%s_%s.png" % (args.filter, str(focus_n)))
