    ...
    def single_evaluation():
        ...
        for r0 in ratios:
            ...
            for prop_value in ratios:
                ...
                gt[r0][prop_value] = {}
                preds_a[r0][prop_value][0] = pa[r0][prop_value][0]
                preds_v[r0][prop_value][0] = pa[r0][prop_value][0]
                gt[r0][prop_value][0]=ground_truths[r0][prop_value][0]
                print("loading old {} on {}".format(r0,prop_value))
                for t in range(1,attack_config.tries):
