...
if __name__ == "__main__":
    ...
    data_config: DatasetConfig = replace(
        model_data_config, prop=fairness_config.prop)
    data_config_lower = replace(data_config, value=fairness_config.value_min)
    data_config_upper = replace(data_config, value=fairness_config.value_max)
