...
if __name__ == "__main__":
    ...
    for ratio in args.ratios:
        ...
        for i in range(1, train_config.num_models + 1):
            ...
            extras = {"train_loss":tlosses,"train_acc":tacces,"loss_dif":list(np.array(vlosses)-np.array(tlosses)),"acc_dif":list(np.array(tacces)-np.array(vacces))}
            logger.add_result(data_config.value, vlosses, vacces,extras,R_cross=list(R_crosses))
