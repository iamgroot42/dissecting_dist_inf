"""
This script trains models needed for comparison attack.
"""
import numpy as np
...
if __name__ == "__main__":
    ...
    if args.end_num:
        assert args.end_num > args.start_num
    else:
        args.end_num=args.start_num+1
        print(args.end_num)
    if args.gpu:
    ...
    for t in range(args.trial_offset,attack_config.tries+args.trial_offset):
        for i in range(args.start_num,args.end_num):

            models_a_1 = attacker_obj.train(models_vic_1[0],0.5,0.5,t,i)
    ...
    for prop_value in attack_config.values:
        ...
        for t in range(args.trial_offset,attack_config.tries+args.trial_offset):
            for i in range(args.start_num,args.end_num):
                attacker_obj.train(models_vic_1[0],prop_value,0.5,t,i)
                attacker_obj.train(models_vic_2[0],0.5,prop_value,t,i)
                attacker_obj.train(models_vic_2[0],prop_value,prop_value,t,i)
            """
