...
Before starting, some paths need to be setup, like ones for saving models, loading data, and saving log files.
Concretely, `base_data_directory` and `base_models_directory` need to be set in `datasets/base.py`
