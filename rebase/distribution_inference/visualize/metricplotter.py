...
class MetricPlotHelper():
    def __init__(self,
        ...
        self.attack_loggers = attack_loggers
    ...
    def _get_logger_from_path_or_obj(self, path, logger_obj):
        ...
        elif (logger_obj is not None) and (type(logger_obj) == AttackResult or type(logger_obj) == TrainingResult):
    ...
    def lineplot(self, title='', darkplot=True, dash=False):
        assert self.columns[0] in self.df, "Ratio column not found"
