...
class CensusWrapper(base.CustomDatasetWrapper):
    ...
    def get_loaders(self, batch_size, custom_limit=None,
        ...
        return super().get_loaders(atch_size, shuffle=shuffle,
...
def generate_victim_adversary_splits(adv_ratio=None, test_ratio=0.33, num_tries=None):
    """
