...
from model_utils import get_models_path, get_models, convert_to_torch, ACTIVATION_DIMS, get_model_activation_representations
...
def optimal_data_for_meta(meta, models_1, models_2,
    ...
    for i in iterator:
        ...
        # Sample 90% of the model at random
        ratio = 0.9
...
if __name__ == "__main__":
    ...
    # Print data
    log_path = os.path.join("log/meta/", args.filter, "meta_act_coor_result")
