        ...
        for p in in_folder:
            with open(os.path.join(log_path,p),'r') as f:
                ...
                for l in ls:
                    ...
                    lst.append(acc)
                for i in lst[0]:
                   data.append([p,i,'Selective acc']) 
                for i in lst[1]:
                    data.append([p,i,'acc'])  
    if args.ex and args.t=='per':
        log_path = os.path.join('./log','ex',"perf_perpoint_{}:{}".format(args.filter,args.ratio))
        in_folder = os.listdir(log_path)
        in_folder.sort()
        for p in in_folder:
            with open(os.path.join(log_path,p),'r') as f:
                ...
                for l in ls:
                    ...
                    lst.append(acc)
                for i in lst[0]:
                    data.append([p,i,'Selective confidence and excluding'])  
    if args.ex and args.t=='acc':
        log_path = os.path.join('./log','ex',"perf_quart_{}:{}".format(args.filter,args.ratio))
        in_folder = os.listdir(log_path)
        in_folder.sort()
        for p in in_folder:
            with open(os.path.join(log_path,p),'r') as f:
                ...
                for l in ls:
                    ...
                    lst.append(acc)
                for i in lst[0]:
                   data.append([p,i,'Selective acc and excluding']) 
