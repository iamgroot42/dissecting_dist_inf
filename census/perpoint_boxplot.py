...
if __name__ == "__main__":
    ...
    columns = [
        ...
        "Accuracy (%)",
        "Selective perpoint confidence threshold test on quartiles"
    ]
    log_path = os.path.join(BASE_MODELS_DIR,args.filter,"perf_perpoint:{}".format(args.ratio))
    ...
    sns_plot.figure.savefig("./images/perpoint_quartiles_{}".format(args.filter))
