...
if utils.check_if_inside_cluster():
    BASE_DATA_DIR = "/scratch/as9rw/datasets/census"
else:
...
PROPERTY_FOCUS = {"sex": "Female", "race": "White", "bothfw": "both f and w",
                  "bothmw": "both m and w", "bothfn": "both f and n",
                  "bothmn": "both m and n", "two_attr": "f and w"}
...
def heuristic2(df,  ratio1, ratio2, cwise_sample, class_imbalance=3.0,
               n_tries=100, class_col="income", verbose=True):
    vals, pckds, err = [], [], []
