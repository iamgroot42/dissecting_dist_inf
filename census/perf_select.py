...
def select_points(model1,model2,x,Y,ratio = 0.1):
    ...
    re = da[np.argsort(da[:, -1])][::-1][:int(ratio*total)]
    y = re[:,-2]
    x = re[:,:-2]
    return x,y
...
if __name__ == "__main__":
    ...
    for _ in range(args.tries):
        ...
        #y_te_1 = y_te_1.ravel()
        #y_te_2 = y_te_2.ravel()
        x_te_1, y_te_1 = select_points(models_1,models_2,x_te_1,y_te_1)
        x_te_2, y_te_2 = select_points(models_1,models_2,x_te_2,y_te_2)
