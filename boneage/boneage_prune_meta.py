...
if __name__ == "__main__":
    ...
    dims, vecs_train_1 = get_model_features(
        ...
        ratio=args.first, first_n=args.first_n, start_n=args.start_n, prune_ratio=args.prune_ratio,
        max_read=1000)
    ...
    _, vecs_test_1 = get_model_features(
        ...
        ratio=args.second, first_n=args.first_n, start_n=args.start_n, prune_ratio=args.prune_ratio,
        max_read=1000)
